...
public class GeneratorTest {
    ...
    public void whenByButThisSessionDoesNotExist() {
        ...
        if (mapForGenerator.containsKey("name") && mapForGenerator.containsKey("subject") && mapForGenerator.size()>2) {
    ...
    public void whenAllOk() {
        ...
        mapForGenerator.put("subject", "you");
        mapForGenerator.put("name", "Vika");
        assertThat("I am a Vila, Who are you?",  generator.produce("I am a ${name}, Who are ${subject}?", mapForGenerator););
    }
}